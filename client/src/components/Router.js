...
const Router = ({ login, getUserCred, user, order, updateOrder, orderHist, getOrderHist, cancelOrder, cancel, isReady, getHistory, cart, addToCart, checkoutCart }) => {
  return (
  <Routes>
    ...
    <Route path='/cart' element={<Cart cart={cart} isReady={isReady} updateOrder={updateOrder} order={order} checkoutCart={checkoutCart}/>} />
  </Routes>
  );
}
